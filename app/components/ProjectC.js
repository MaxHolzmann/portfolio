export default function ProjectC({
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="mx-10 flex flex-col items-center justify-center rounded-lg border-2 border-solid border-[#0055ff] bg-white shadow-md">
      <h1 className=" text-center text-5xl">{title}</h1>
      <img src={image} className="w-96 rounded-lg shadow-md"></img>
      <div>
